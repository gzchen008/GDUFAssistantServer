						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<form
									...
									<%-- <div class="form-group row">
										<label for="file-Portrait" class="col-sm-2 control-label">社团图标</label>
										<div class="col-sm-5">
											<div id="uploader">
												<div class="queueList">
													<div id="dndArea" class="placeholder">
														<div id="filePicker"></div>
														<p>将tu拖到这里，单次最多可选300张</p>
													</div>
												</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<textarea class="form-control" rows="5" style="resize: none"
												placeholder="请输入社团描述" name="cdescribe"></textarea>
										</div>
									</div>
									<div class="form-group row">
