			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<form role="form"
							action="${pageContext.request.contextPath }/admin/main.action"
							method="post">
							<fieldset>
								...
								<div class="form-group">
									<input class="form-control" placeholder="密码" name="apwd"
										type="password" value="">
								</div>
								<!-- <div class="checkbox">
					...
					<div class="alert alert-danger" role="alert"
						style="padding: 10px; width: 90%; margin: 5px auto; display: none;">
