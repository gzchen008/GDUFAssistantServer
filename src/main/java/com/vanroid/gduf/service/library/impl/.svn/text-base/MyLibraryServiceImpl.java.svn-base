...
public class MyLibraryServiceImpl implements MyLibraryService{
	 ...
	 */
	/*@Deprecated
	public void sendVeriCode(HttpClient httpClient,ServletOutputStream outputStream) {
		// 生成验证码地址
		String url = "http://218.192.12.92/gencheckcode.aspx";
		//TODO 
	 ...
	 */
	@Deprecated
	public int login(HttpClient httpClient,String stuId, String libaryPass, String veriCode) {
	...
	public List<BookBorrowedInfo> findBookborrowedhistory(HttpClient httpClient,String page) {
		String url = "http://218.192.12.92/user/bookborrowedhistory.aspx?page="+page;
		HttpGet httpGet = HttpUtil.getHttpGet(httpClient, url);
		HttpResponse resp;
		List<BookBorrowedInfo> beanList = null;
		try {
