...
public class CourseServiceTest {
	...
	public void testgetCourse(){
		...
		jwcLoginService.login(httpClient, jwcInfo );
		
		
		
		course.setStuId(jwcInfo.getXh());
		course.setXq(1);
		course.setYear("2015-2016");
		
		Course course1 = courseService.getCourseInfo(new JWCHandler(httpClient),course, xm);
		for(ClassBean c:course1.getClasses()){
